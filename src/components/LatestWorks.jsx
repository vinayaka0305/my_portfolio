...
import calculator from "../mockups/cal.png";
import game from "../mockups/game_tic.png";
  ...
  return (
    <section className="max-w-screen-xl mx-auto px-4 relative sm:pb-16">
      ...
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-['80px'] items-center mt-12 sm:mt-8 relative">
        {/* connecting line */}
        <div className="h-[1px] left-1/4 right-1/2 bg-[#df3409] absolute top-1/2 hidden sm:block"></div>
        {/* connecting-dot */}
      ...
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-['80px'] items-center mt-12 sm:mt-16 relative">
        ...
        {/* connecting line */}
        <div className="h-[1px] left-1/2 right-1/4 bg-[#0f69c3] absolute top-1/2 hidden sm:block"></div>
        {/* connecting-dot */}
      ...
      {/*project Calculator*/}
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-['80px'] items-center mt-14 sm:mt-16 relative">
        {/* connecting line */}
        <div className="h-[1px] left-1/4 right-1/2 bg-[#a8d7db] absolute top-1/2 hidden sm:block"></div>
        {/* connecting-dot */}
        <div className="w-4 h-4 rounded-full border-[3px] border-[#a8d7db] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-125 ease-in-out duration-100 hidden sm:block"></div>
        <a
          href="https://calculatorbasic.onrender.com/"
          target="_blank"
          className="flex w-full relative justify-center sm:justify-start"
        >
          <div className="flex flex-col items-center relative group sm:hover:scale-105 ease-in-out duration-200">
            ...
            <span className="flex group-hover:-top-14 ease-jump duration-200 bg-[#9aa6e0] sm:absolute left-1/2 sm:-translate-x-1/2 top-5 px-2 py-1 text-sm sm:text-base mt-2 rounded w-max items-center gap-1 after:hidden sm:after:block sm:after:items-center after:w-4 after:h-4 after:bg-inherit after:absolute after:left-1/2 after:-translate-x-1/2 after:rotate-45 after:-bottom-2">
              basic_calculator
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        <div class="w-full">
          <h3 class="text-[#9aa6e0] font-bold text-2xl md:text-4xl">
            {" "}
            Basic Calculator
          </h3>
          {/* <span class="text-[#9aa6e0] text-base md:text-lg">(music)</span> */}
          <p class="text-justify text-sm md:text-base mt-2">
            This calculator was developed using HTML, CSS, and JavaScript,
            offering users a straightforward tool to perform everyday
            calculations with a responsive and visually appealing design.
          </p>
      ...
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-['80px'] items-center mt-12 sm:mt-16 relative">
        <div class="w-full">
          <h3 class="text-[#ffe400] font-bold text-2xl md:text-4xl">
            tic_tac_toe
          </h3>
          <span class="text-[#ffe400] text-base md:text-lg">(game)</span>
          <p class="text-justify text-sm md:text-base mt-2">
          This interactive Tictactoe game was developed using HTML, CSS, and JavaScript, offering a fun and simple
          way for users to play the classic game directly in the browser.
          </p>
        ...
        {/* connecting line */}
        <div className="h-[1px] left-1/2 right-1/4 bg-[#ffe400] absolute top-1/2 hidden sm:block"></div>
        {/* connecting-dot */}
        <div className="w-4 h-4 rounded-full border-[3px] border-[#ffe400] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-125 ease-in-out duration-100 hidden sm:block"></div>
        <a
          href="https://tic-tac-toe-basicgame.onrender.com/"
          target="_blank"
          className="order-1 sm:order-2 flex w-full relative justify-center sm:justify-start"
        >
          <div className="flex flex-col items-center relative group sm:hover:scale-105 ease-in-out duration-200 sm:ml-auto">
            ...
            <span className="flex group-hover:-top-14 ease-jump duration-200 text-black bg-[#ffe400] sm:absolute left-1/2 sm:-translate-x-1/2 top-5 px-2 py-1 text-sm sm:text-base mt-2 rounded w-max items-center gap-1 after:hidden sm:after:block after:w-4 after:h-4 after:bg-inherit after:absolute after:left-1/2 after:-translate-x-1/2 after:rotate-45 after:-bottom-2">
             tic_tac_toe
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
