...
const HomeComponent = () => {
  ...
  const scrollSection = () => {
    if (sectionRef.current) {
      ...
      const scrollPosition = offsetTop - -620; // Scroll 100px above the section
    ...
    <section className="flex flex-col justify-between h-screen">
      <header className="pointer-events-none z-10 flex items-center justify-between mx-4 mt-4 max-w-screen-2xl forced-color-adjust-auto">
        ...
        <nav className="flex pointer-events-auto gap-4 mx-1 cursor-pointer">
          <a
            href="tel:8749018405"
            className="transition-transform duration-300 ease-in-out hover:scale-150 hover:rotate-6 hover:opacity-80 hover:text-blue-500"
          >
            {/* telephone logo */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            target="_blank"
            className="transition-transform duration-300 ease-in-out hover:scale-150 hover:rotate-6 hover:opacity-80 hover:text-[#00d757]"
          >
            {/* whatsapp logo */}
            <svg
              aria-hidden="true"
      ...
      <div className="flex -mt-10 relative z-10">
        ...
        <ul className="ml-auto space-y-6 text-[#b0b2c3] absolute right-8">
          ...
          <li>
            {/* x logo */}
            <a
              href="https://x.com/BheeshmaA18212?t=u6Yb7agGwxWZdMe0x4aiqA&s=09"
              target="_blank"
            >
              <svg
