...
const LetsConnect = () => {
  ...
  return (
    <section className="max-w-screen-xl mx-auto px-4 pb-12">
      <h2 className="text-3xl sm:w-max sm:text-[40px] bg-[#111] relative font-bold px-4 py-2 text-center mx-auto sm:border-2 border-[#ff3cac] rounded-md">
        Let's Connect
      </h2>
        ...
        >
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              value={name}
              className="bg-gray-50 border-2 outline-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#ff3cac] focus:border-[#ff3cac] block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
          ...
          <button
            type="submit"
            className="w-full text-white bg-[#ff3cac] hover:bg-[#ff3caab9] focus:ring-4 focus:ring-[#4489a0] font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none"
          >
            Send
          </button>
        </form>
